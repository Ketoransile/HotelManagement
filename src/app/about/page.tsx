...
//   return (
//     <div className="min-h-screen flex flex-col gap-20 items-start  py-12">
//       {/* AboutHero */}
...
//             <p className="text-sm">
//               Founded in 2005, our hotel blends modern luxury with timeless
//               hospitality to create unforgettable stays.
//             </p>
//           </div>
//         </div>
//         <div className="flex items-center justify-between gap-4">
//           <div className="flex items-center gap-4 border border-neutral-300 rounded-xl p-6">
//             <Image
//               src={heroImage}
//               width={1000}
//               height={1000}
...
//             />
//             <div className="flex flex-col gap-2">
//               <h1 className="text-xl font-bold">A Rich Heritage</h1>
//               <p className="text-sm">
//                 Nestled in the heart of the city, our hotel has been a place of
//                 comfort and conviviality for years.
//               </p>
//             </div>
//           </div>
//           <div className="flex items-center gap-4 border border-neutral-300 rounded-xl p-6">
